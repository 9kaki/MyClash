本仓库源自于大佬[AIsouler](https://github.com/AIsouler)，因为我自己有别的需求且又懒（懒得每次下载脚本改规则），所以创建了一个分支。
# MyClash
...
```txt
https://raw.githubusercontent.com/9kaki/MyClash/main/Script/mihomoScript.js
```
